...
const RobotIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M15 4H9V2h6v2zM4 16h16V9H4v7zm4-4h2v2H8v-2zm6 0h2v2h-2v-2zM4 20h16v-2H4v2z" />
      <path d="M20,7H4A1,1,0,0,0,3,8v8a1,1,0,0,0,1,1H20a1,1,0,0,0,1-1V8A1,1,0,0,0,20,7Zm-1,8H5V9H19Z" />
    </svg>
);
