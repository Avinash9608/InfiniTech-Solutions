...
const RobotIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM8.5 10a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm7 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zM12 18.5c-2.32 0-4.394-1.252-5.5-3.134.13-.05.264-.1.404-.15C7.94 14.774 9.89 14.5 12 14.5s4.06.274 5.096.716c.14.05.274.1.404.15C16.394 17.248 14.32 18.5 12 18.5z" />
    </svg>
);
